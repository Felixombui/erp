...
$count = "SELECT * FROM quotationids WHERE id='$id'";
...
$pdf->Cell( 180, 8, 'QUOTATION', 0, 0, R );
$pdf->Ln( 4 );
$pdf->SetFont( 'Arial', '', 8 );
...
$pdf->Ln( 6 );
$pdf->SetFont( 'Arial', '', 8 );
$stringTerms=explode(' ',$paymentterms);
$counter=count($stringTerms);
$counted=($counter/10)+1;
$lastindex=0;
//if($counter>40){
    $pdf->Cell( 50, 6, $stringTerms[0].' '.$stringTerms[1].' '.$stringTerms[2].' '.$stringTerms[3].' '.$stringTerms[4].' '.$stringTerms[5].' '.$stringTerms[6].' '.$stringTerms[7].' '.$stringTerms[8].' '.$stringTerms[9].' ', 0, 0, L );
    $pdf->Ln(5);
    $pdf->Cell( 50, 6, $stringTerms[10].' '.$stringTerms[11].' '.$stringTerms[12].' '.$stringTerms[13].' '.$stringTerms[14].' '.$stringTerms[15].' '.$stringTerms[16].' '.$stringTerms[17].' '.$stringTerms[18].' '.$stringTerms[19].' ', 0, 0, L );
    $pdf->Ln(5);
    $pdf->Cell( 50, 6, $stringTerms[20].' '.$stringTerms[21].' '.$stringTerms[22].' '.$stringTerms[23].' '.$stringTerms[24].' '.$stringTerms[25].' '.$stringTerms[26].' '.$stringTerms[27].' '.$stringTerms[28].' '.$stringTerms[29].' ', 0, 0, L );
    $pdf->Ln(5);
    $pdf->Cell( 50, 6, $stringTerms[30].' '.$stringTerms[31].' '.$stringTerms[32].' '.$stringTerms[33].' '.$stringTerms[34].' '.$stringTerms[35].' '.$stringTerms[36].' '.$stringTerms[37].' '.$stringTerms[38].' '.$stringTerms[39].' ', 0, 0, L );
...
$pdf->Output( 'D', 'Quotation'.$id.'.pdf', false );
