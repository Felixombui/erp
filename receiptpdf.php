...
//payment query
$qry = mysqli_query( $config, "SELECT * FROM payments WHERE id='$pid'" );
$row = mysqli_fetch_assoc( $qry );
$id=$row['invoiceno'];
$customername = $row['customer'];
$quotationdate = $row['pdate'];
...
//decide left header spacing

$pdf->Cell( 100, 8, 'RECEIPT', 0, 0, R );
$pdf->Ln( 10 );
$pdf->SetFont( 'Arial', 'B', 12 );
$custchars=(strlen('Ref.: '.$customername.'/'.$id));
$custstart=(180-26)+$custchars;
$pdf->Cell( $custstart-3.5, 8, 'Ref.: '.$customername.'/'.$id, 0, 0, R );
$pdf->Ln( 6 );
$recchars=strlen('Receipt Date: '.$quotationdate)-9;
$pdf->Cell( 175, 8, 'Receipt Date: '.$quotationdate, 0, 0, R );
$pdf->Ln( 6 );
//$pdf->Cell( 180, 8, 'Expiry Date: '.$expirydate, 0, 0, R );
$pdf->Ln( 10 );
$pdf->Cell( 135, 8, 'From:', 0, 0, R );
$pdf->Ln( 6 );
...
$pdf->Ln( 6 );
$pdf->Cell( 50, 6, 'Transaction Code: ', 0, 0, L );
$pdf->Ln( 6 );
$pdf->Cell( 50, 6, $receipt, 0, 0, L );
$pdf->Ln( 10 );
...
$pdf->Ln( 10 );
$pdf->Cell( 50, 6, 'Official Stamp: ', 0, 0, L );
$pdf->Ln( 6 );
