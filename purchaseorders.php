<?php
include 'headers.php';
$purchaseqry=mysqli_query($config,"SELECT * FROM orderids");
?>
<style>
...
<img src = 'images/discounted.png' width = '40' height = '40'><br><h4>Purchas Orders</h4>
<p>
<hr color = 'cyan'></p>
<div style="width: 20%;float:right;"><a href="neworder.php" style="color:blue;"><img src="images/add.png" width="30" height="30" align="left">New Order</a></div>
<table width="100%">
    <tr><th>Order ID</th><th>Supplier</th><th>Order Amount (Ksh.)</th><th>Date</th><th>Status</th><th></th></tr>
    <?php
    while($prow=mysqli_fetch_assoc($purchaseqry)){
        $id=$prow['id'];
        $supplier=$prow['supplier'];
